...
class LocalDevFixtures(
    ...
    override fun run(vararg args: String?) {
        ...
        val note2 = CharacterNote(
            "Another note, but one with a lot more text. This note allows us to test the wrapping and te" +
        ...
        val note3 = CharacterNote(
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ipsum libero, dictum at faci" +
        ...
        val label2 = Label("Non-owned label", true, campaign3, mutableListOf(char3))
        val label3 = Label("Non-owned invisible label", false, campaign3, mutableListOf(char3))
        char1.labels.add(label1)
        char3.labels.add(label2)
        char3.labels.add(label3)
        campaign1.labels.add(label1)
        campaign3.labels.add(label2)
        campaign3.labels.add(label3)
